...
public class IngresoUsuario extends AppCompatActivity {
    ...
    private void registrarPerfiles() {
        ...
        values2.put(Utilidades.CAMPO_PERFIL_NOMBRE,"Perfil 2");
        Long idResultante2 = db.insert(Utilidades.TABLA_PERFILES, Utilidades.CAMPO_IDPERFIL,values2);
        Toast.makeText(getApplicationContext(),"Id Registro2: " + idResultante2,Toast.LENGTH_SHORT).show();

        //--> Cargo Relacion Perfil-Usuario
        ContentValues valuesRel2 = new ContentValues();
        valuesRel2.put(Utilidades.CAMPO_IDPERFILU,idResultante);
        valuesRel2.put(Utilidades.CAMPO_IDPERFIL_USUARIO,tvUsuarioLog.getText().toString());
        Long idResultanteRel2 = db.insert(Utilidades.TABLA_USUARIO_PERFILES, Utilidades.CAMPO_IDPERFIL,valuesRel2);
        Toast.makeText(getApplicationContext(),"Id Registro Relacion2: " + idResultanteRel2,Toast.LENGTH_SHORT).show();
